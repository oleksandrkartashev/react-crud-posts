...
const AddPost: React.FC<PostAddPopupProps> = ({
  ...
  return (
    <>
      <div
        aria-hidden="true"
        className={`popup popup--edit ${popupVisibleClass} bg-black bg-opacity-30 dark:bg-white dark:bg-opacity-30 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}
      >
