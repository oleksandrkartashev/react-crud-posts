  ...
  return (
    <>
      <div>
        <button
          onClick={toggleTheme}
          className={`theme-toggle theme-${theme} relative flex items-center justify-between rounded-3xl px-1 py-1 border-solid border border-white min-w-16`}
        >
