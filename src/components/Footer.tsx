  ...
  return (
    ...
    <footer className="border-t-2 py-4">
      <div className="flex justify-center space-x-6">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none" className="w-6 h-6 fill-black dark:fill-white">
        ...
        <a href="https://github.com/oleksandrkartashev/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <svg xmlns="http://www.w3.org/2000/svg" height="800px" width="800px" version="1.1"  fill="none" viewBox="-143 145 512 512" className="w-6 h-6 fill-black dark:fill-white">
            <g>
