      ...
      <button onClick={() => navigate(-1)} className='bg-black dark:bg-white text-white dark:text-black cursor-pointer leading-none mb-4 min-w-[100px] px-3 py-2'>Back</button>
        <div className="post post-single flex-col">
          ...
          <div className="post-actions flex items-center border-b-2 justify-center px-4 py-4 md:px-7 md:py-7">
            <button onClick={openEditPopup} className='bg-black dark:bg-white text-white dark:text-black leading-none min-w-[100px] px-3 py-2 mx-2'>Edit post</button>
            <button  onClick={HandleDeletePost} className='bg-black dark:bg-white text-white dark:text-black leading-none min-w-[100px] px-3 py-2 mx-2'>Delete post</button>
          </div>
        </div>
      </div>
      {isPopupOpen && (
